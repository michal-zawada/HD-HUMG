...
params.vcfTodb = "***create_db/ref_db/vcf_upload/vcf_to_db.py"

//params.reads = "***fastq_NF_tests/*_R{1,2}.fastq" //3 pairs of normal size fastq
params.reads = "***fastq/*_R{1,2}.fastq" //3 pairs of small size test fastq files
//params.reads = "***fastq_CG/*_R{1,2}.fastq"
//params.samplesConfig="***current_run/samplesToRun_*.csv"
params.samplesConfig="***current_run_WGS_test/samplesToRun_*.csv"

params.hg38 = "***GRCh38.primary_assembly.genome.fa"
...
params.bedSureSelect = "***sureselect_all_exon_v7_hs_hg38/S31285117_Regions_genes.bed"
params.bedSureSelect25bpExtend = "***genomes/bed_hg38/agilent_bed/S31285117_agi_25bp_extended.bed"

params.hapmap = "***GATK_resource_bundle/hapmap_3.3.hg38_noChr.vcf.gz"
params.omni = "***GATK_resource_bundle/1000G_omni2.5.hg38_noChr.vcf.gz"
params.g1000G = "***GATK_resource_bundle/1000G_phase1.snps.high_confidence.hg38_noChr.vcf.gz"
params.mills = "***GATK_resource_bundle/Mills_and_1000G_gold_standard.indels.hg38_noChr.vcf.gz"
